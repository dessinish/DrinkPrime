...
if (isValid) {
  ...
  if (document.querySelector('input[name="RadioPlan"]:checked')) {
    selectedRadio = document.querySelector('input[name="RadioPlan"]:checked');
    planType = selectedRadio.getAttribute('planType');
    planDuration = selectedRadio.getAttribute('planDuration');
  } else if (document.querySelector('input[name="RadioPlanMob"]:checked')) {
    selectedRadio = document.querySelector('input[name="RadioPlanMob"]:checked');
    planType = selectedRadio.getAttribute('planType');
    planDuration = selectedRadio.getAttribute('planDuration');
  }
...
const url = `https://drinkprime.in/lpcheckout?plan=${encodeURIComponent(planType)}&duration=${encodeURIComponent(planDuration)}&name=${encodeURIComponent(nameParam)}&phone=${encodeURIComponent(phoneParam)}&city=${encodeURIComponent(cityParam)}&coupon=${encodeURIComponent(coupon)}`;
setTimeout(function() {
