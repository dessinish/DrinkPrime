document.addEventListener("DOMContentLoaded", function () {
  ...
  var submitButton = document.getElementById("submit-wa");
  var cityChoice = document.getElementById("cityField-wa");
  var cityError = document.getElementById("city-wa-error");
  var otherName = document.getElementById("othersField-wa");
  var othersError = document.getElementById("others-wa-error");
  ...
  cityChoice.addEventListener("change", function () {
    ...
    if (cityChoice.value === "Others") {
      document.getElementById("othersField-wa").style.display = "block";
      othersValue = otherName.value;
    } else {
      document.getElementById("othersField-wa").style.display = "none";
    }
  });
  document.getElementById("othersField-wa").addEventListener("change", function () {
    othersValue = otherName.value;});
  document.getElementById("submit-wa").addEventListener("click", async function () {
    var namePop = document.getElementById("name-wa");
    var nameError = document.getElementById("name-wa-error");
    var phonePop = document.getElementById("phone-wa");
    var phoneError = document.getElementById("phone-wa-error");
    var referralCode = document.getElementById("referral-wa");
    var isValid =true;
    if (cityChoice.value === "") {
    ...
    if (isValid) {
      ...
      const url = 'https://wa.link/61q8wq';
      setTimeout(function() {
