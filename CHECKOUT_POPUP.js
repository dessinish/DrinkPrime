document.addEventListener("DOMContentLoaded", function () {
  ...
  document.getElementById("submit-checkout").addEventListener("click", async function () {
    ...
    if (isValid) {
      ...
      const url = `https://drinkprime.in/lpcheckout?plan=SOLO&duration=28&name=${encodeURIComponent(nameParam)}&phone=${encodeURIComponent(phoneParam)}&city=${encodeURIComponent(cityParam)}`;
      setTimeout(function() {
